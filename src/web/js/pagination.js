...
const CORP_ID_FIELDS = ['#add-player-corp', '#manage-player-corp']
for(let field of CORP_ID_FIELDS) {
...
const RUNNER_ID_FIELDS = ['#add-player-runner', '#manage-player-runner']
for(let field of RUNNER_ID_FIELDS) {
...
$("#manage-player-close").addEventListener("click", (e) => {
  e.preventDefault()
  $("#manage-player").classList.add('inactive')
})
